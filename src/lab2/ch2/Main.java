...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Film film1 = new Film(1990,"Film cu actor de oscar",
        ...
        Film film3 = new Film(2010,"Film cu actor fara premii 3",
                new Actor[]{actorFaraPremiu01,actorFaraPremiu02,actorFaraPremiu03});
        Film film4 = new Film(2018,"Film cu actori de oscar",
                new Actor[]{actorOscar2010,actorOscar2018,actorFaraPremiu02});
        Film film5 = new Film(2018,"Film cu actori fara premii",
                new Actor[]{actorFaraPremiu03,actorFaraPremiu02});
